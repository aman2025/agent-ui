...
class PromptComposer {
   ...
   */
  composeSystemPrompt() {
    console.log('[DEBUG] PromptComposer.composeSystemPrompt - Starting...');
    ...
    console.log('[DEBUG] PromptComposer.composeSystemPrompt - Completed in', Date.now() - startTime, 'ms');
    console.log('[DEBUG] PromptComposer.composeSystemPrompt - Total length:', result.length, 'chars');
    return result;
  }
