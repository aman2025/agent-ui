...
- data.path (string, required): Path to data array in the data model. For tool execution results, use "data.<arrayName>" (e.g., "data.instances", "data.items"). The tool result structure is { success, data: { ... }, error, metadata }.
